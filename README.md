...
이 프로젝트는 **3계층 문서 체계**를 따릅니다:

| 문서 | 대상 | 목적 |
|------|------|------|
| **[README.md](README.md)** (이 파일) | 👤 사람 (사용자) | 빠른 시작, 온보딩 |
| **[CLAUDE.md](CLAUDE.md)** | 🤖 Claude 에이전트 | 운영·구조·설정 (HOW) |
| **[SOUL.md](SOUL.md)** | 🎯 기여자 | 판단·원칙·가치 (WHY) |

**어디서 시작할까?**
- 🚀 처음 사용: README.md의 [빠른 시작](#-빠른-시작)
- 🔧 설정/운영: CLAUDE.md 읽기
- 💡 개선하고 싶음: SOUL.md 읽기
